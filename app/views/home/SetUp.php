...
function setup()
{
    ...
    $medical->makeTable(
        "patients",
        array(
            'PatientID', 'RegNo', 'FullName',  'Gender', 'FullAddress', 'DateOfBirth', 'DiagnosisID',
            'BedNo', 'ContactNo'
        ),
        array(
            "INT NOT NULL PRIMARY KEY AUTO_INCREMENT", "VARCHAR(20) NOT NULL UNIQUE", "VARCHAR(70) NOT NULL", "VARCHAR(10) NOT NULL",
    ...
    $medical->makeTable(
        "dischargedPatients",
        array(
            'DischargedPatientID', 'RegNo', 'FullName', 'Gender', 'FullAddress', 'DateOfBirth',
            'DiagnosisID', 'BedNo', 'ContactNo', 'DischargedDate'
        ),
        array(
            "INT NOT NULL PRIMARY KEY AUTO_INCREMENT", "VARCHAR(20) NOT NULL", "VARCHAR(70) NOT NULL", "VARCHAR(10) NOT NULL",
    ...
    $attributes = array(
        'INT PRIMARY KEY NOT NULL AUTO_INCREMENT', 'VARCHAR(20) NOT NULL', ' DATE NOT NULL',
