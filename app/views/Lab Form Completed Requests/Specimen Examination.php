...
<body class="mainbody">
  ...
  $results =  $medical->retrieveData("specimen_exam_table", array('test_request_date'), $_SESSION["regNo"]);
  if (sizeof($results) != 0) {
    foreach ($results as $row) {
      ...
      echo
        "
           <tr>
           <form action = \"../../views/Lab Forms/Specimen Examinations.php\" method = post>
