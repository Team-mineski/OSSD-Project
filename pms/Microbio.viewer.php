...
session_start();
if ((!(isset($_SESSION["username"]))) || ($_SESSION["type"] != "microbio_lab")) {
    ...
    <form action="Microbio.control.php" method="POST">
        <div class="container">
            ...
            <div class="form-group">
                ...
                <input type="text" name="diagnosis" id="diagnosis" class="form-control form-control-sm " readonly value="<?php echo $patient->getDiagnosis(); ?> " </div> <div class="form-group">
