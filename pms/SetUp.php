...
function setup()
{
    ...
    $medical->makeTable(
        "microbio_table",
        array(
            'result_id', 'test_request_date', 'regNo', 'lab_no', 'BHT_no',
        ...
        array(
            'INT PRIMARY KEY NOT NULL AUTO_INCREMENT', 'DATE DEFAULT NULL', 'VARCHAR(20) DEFAULT NULL', 'INT DEFAULT NULL', 'varchar(20) DEFAULT NULL',
    ...
    $medical->makeTable(
        "specimen_exam_table",
        array(
            'result_id', 'test_request_date', 'serial_no', 'regNo', 'BHT_no', 'exams', 'collect_date',
        ...
        array(
            'INT PRIMARY KEY NOT NULL AUTO_INCREMENT', 'DATE DEFAULT NULL', 'VARCHAR(20) DEFAULT NULL ', 'VARCHAR(20) DEFAULT NULL ', 'VARCHAR(20) DEFAULT NULL', 'VARCHAR(60) DEFAULT NULL', ' DATE DEFAULT NULL',
    ...
    $medical->makeTable(
        "ecg_table",
        array(
            'result_id', 'test_request_date', 'regNo', 'BHT_no', 'surgeon', 'standard_lead',
            'other_lead', 'sigMO', 'reg_no', 'remarks',
            'finishedDate', 'sigcardio'
        ),
        array(
            'INT PRIMARY KEY NOT NULL AUTO_INCREMENT', 'DATE DEFAULT NULL', 'VARCHAR(20) DEFAULT NULL', 'VARCHAR(10) DEFAULT NULL', 'VARCHAR(20) DEFAULT NULL', 'VARCHAR(60) DEFAULT NULL', 'VARCHAR(60) DEFAULT NULL',
    ...
    $medical->makeTable(
        "xray_table",
        array(
            'result_id', 'test_request_date', 'regNo', 'bht_no', 'surgeon',
            'signature', 'stamp', 'xray_no', 'xray_room',
            'size', 'remarks', 'sign_radio', 'completed_date', 'region'
        ),

        array(
            'INT PRIMARY KEY NOT NULL AUTO_INCREMENT', 'DATE DEFAULT NULL', 'VARCHAR(20) NOT NULL', 'varchar(20) DEFAULT NULL', 'VARCHAR(60) NOT NULL',
    ...
    $medical->makeTable(
        "biochemical_table",
        array(
            'result_id', 'regNo', 'test_request_date', 'lab_ref_no', 'bht_no', 'fasting_status',
        ...
        array(
            'INT PRIMARY KEY NOT NULL AUTO_INCREMENT', 'VARCHAR(20) DEFAULT NULL ', 'DATE DEFAULT NULL', 'INT DEFAULT NULL ', 'varchar(20) DEFAULT NULL', 'varchar(20) DEFAULT NULL',
